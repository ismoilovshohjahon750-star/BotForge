        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute top-16 left-0 right-0 border-b bg-card shadow-2xl z-40 overflow-hidden max-w-xl mx-auto sm:rounded-2xl sm:mt-2 sm:border"
            >
              <div className="p-4 sm:p-5 flex flex-col gap-2 bg-card/95 backdrop-blur-md">
                {user && (
