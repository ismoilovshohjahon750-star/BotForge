      ...
      <footer className="py-10 border-t border-zinc-800 bg-zinc-950/60 mt-auto">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-xs text-zinc-400 font-mono">
            © 2026 BOTFORGE. Barcha huquqlar himoyalangan.
          </p>
          ...
          <div className="relative w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl overflow-hidden text-zinc-100 p-6">
            ...
            {activeModal === 'shartlar' && (
              <div className="space-y-4 text-xs text-zinc-300 max-h-[60vh] overflow-y-auto pr-2 leading-relaxed">
                ...
                <p>
                  BotForge platformasi Telegram va Discord botlarini 24/7 cloud serverlarda xavfsiz saqlash va ishga tushirish xizmatini taklif etadi.
                </p>
                ...
                <p>
                  BotForge platformasi botlarning 24/7 uzluksiz va yuqori tezlikda ishlashini ta'minlashga harakat qiladi.
                </p>
              </div>
            )}
            ...
            {activeModal === 'kontakt' && (
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {/* Email Card */}
                  <div className="p-3.5 rounded-xl bg-zinc-950/80 border border-zinc-800/80 hover:border-cyan-500/40 transition-all flex flex-col justify-between">
                    <div>
                      <div className="flex items-center gap-2 text-cyan-400 text-xs font-semibold mb-1">
                        <Mail className="w-4 h-4" />
                        <span>Email manzil</span>
                      </div>
                      <p className="text-xs text-zinc-200 font-mono break-all font-medium">
                    ...
                    <div className="flex items-center gap-2 mt-3 pt-2 border-t border-zinc-800/50">
                      <button
                        ...
                        className="text-[11px] px-2.5 py-1 rounded bg-zinc-800 hover:bg-zinc-700 text-zinc-200 flex items-center gap-1 transition-colors"
                      >
                      ...
                      <a
                        ...
                        className="text-[11px] px-2.5 py-1 rounded bg-cyan-950/50 hover:bg-cyan-900/60 text-cyan-300 border border-cyan-800/50 transition-colors"
                      >
                        Yozish
                      </a>
                    </div>
                  ...
                  {/* Phone / Telegram Card */}
                  <div className="p-3.5 rounded-xl bg-zinc-950/80 border border-zinc-800/80 hover:border-emerald-500/40 transition-all flex flex-col justify-between">
                    <div>
                    ...
                    <div className="flex items-center gap-2 mt-3 pt-2 border-t border-zinc-800/50">
                      ...
                      <a
                        ...
                        className="text-[11px] px-2.5 py-1 rounded bg-emerald-950/50 hover:bg-emerald-900/60 text-emerald-300 border border-emerald-800/50 transition-colors"
                      >
                        Qo'ng'iroq
                      </a>
                    </div>
