...
import { BookOpen, Terminal, Rocket, Server, Shield, Code, ChevronRight, Menu } from 'lucide-react';
        ...
        >
          {activeSection === 'about' && (
            <div className="space-y-6">
              <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground">BotForge platformasi haqida</h1>
              <p className="text-lg text-muted-foreground leading-relaxed">
                BotForge — bu Telegram, Discord va boshqa platformalar uchun yaratilgan botlarni oson va tezkor yuklash,
          ...
          {activeSection === 'how-it-works' && (
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                BotForge orqali botingizni ishga tushirish jarayoni juda oddiy va 3 bosqichdan iborat:
              </p>
              ...
              <div className="space-y-8 mt-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">BotForge sizning <code>package.json</code>, <code>requirements.txt</code> kabi fayllaringizni aniqlaydi va kerakli kutubxonalarni avtomatik o'rnatadi.</p>
                  </div>
                </div>
                <div className="flex gap-4">
          ...
          {activeSection === 'supported' && (
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                BotForge deyarli barcha mashhur dasturlash tillari va freymvorklarini qo'llab-quvvatlaydi.
              </p>
