...
export const Messages: React.FC = () => {
  ...
  const handleSendReply = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (partner.email && partner.email.toLowerCase() !== user.email?.toLowerCase() && partner.email !== 'admin@botforge.uz') {
        try {
        ...
        <div className="p-3 bg-[#17212b] border-b border-[#0e1621] flex flex-col gap-2.5 shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-white text-base tracking-wide leading-tight">BotForge Chat</h1>
